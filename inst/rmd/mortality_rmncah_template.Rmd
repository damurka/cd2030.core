...
```{r}
mmr_plot <- cache$filter_mortality_summary('mmr')
plot(mmr_plot) +
  cd_report_theme()
```
...
```{r}
sbr_plot <- cache$filter_mortality_summary('sbr')
plot(sbr_plot) +
  cd_report_theme()
```
...
mortality_ratio <- cache$summarise_completeness_ratio('mmr')
plot(mortality_ratio) +
  cd_report_theme()
```
...
mortality_ratio <- cache$summarise_completeness_ratio('sbr')
plot(mortality_ratio) +
  cd_report_theme()
```
