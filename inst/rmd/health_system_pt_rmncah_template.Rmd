...
Análises subnacionais de insumos do sistema de saúde e resultados dos serviços são críticas: distritos e regiões são unidades‑chave dos sistemas de saúde e de sua prestação de serviços. Isso inclui a avaliação dos insumos do sistema (força de trabalho em saúde, infraestrutura) e dos resultados (uso, cobertura).

### Indicadores do Sistema Nacional de Saúde
...
### Indicadores Subnacionais do Sistema de Saúde
