...
admin_level_1_mapping %>% 
  filter_mapping_data('ideliv', denominator = cache$maternal_denominator,
...
equiplot_wealth(cache$wiq_survey, 'ideliv') +
  cd_report_theme()
```

```{r, fig.cap='Institutioinal Deliveries coverage by maternal education, recent surveys'}
equiplot_education(cache$education_survey, 'ideliv') +
  cd_report_theme()
```
