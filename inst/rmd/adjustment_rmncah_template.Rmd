...
adjustments %>% 
  ...
  plot(title = 'Comparison of number of live births before and after adjustments for completness and outliers') +
  cd_report_theme()
```
...
adjustments %>% 
  ...
  plot(title = 'Comparison of number of penta1 vaccination before and after adjustments for completness and outliers') +
  cd_report_theme()
```
