...
report_themes <- function() {
  base <- list(
    ...
    header = "{report_title}", footer = "Countdown to 2030 \u00b7 {country}",
...
report_default_cover <- function() {
  list(layout = "band", kicker = "Countdown to 2030 \u00b7 {country}", title = "", subtitle = "", show_flag = TRUE,
