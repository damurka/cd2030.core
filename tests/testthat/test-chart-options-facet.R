...
test_that("the panel options are validated", {
  ...
  expect_error(cd_chart_options(facet_ncol = 0), class = "cd2030_error")
  expect_error(cd_chart_options(facet_nrow = 21), class = "cd2030_error")
  expect_error(cd_chart_options(facet_ncol = 2.5), class = "cd2030_error")
  expect_error(cd_chart_options(facet_scales = "wobbly"), class = "cd2030_error")
  expect_error(cd_chart_options(strip_position = "middle"), class = "cd2030_error")
